...
#from tensorflow.python.keras.utils.data_utils import get_fileutils.get_source_inputs
...
def MobileNet(input_shape=None,
    ...
    x = _depthwise_conv_block(x, 128, alpha, depth_multiplier,
                              strides=(1, 1), block_id=2, attention_module=attention_module)
    x = _depthwise_conv_block(x, 128, alpha, depth_multiplier, block_id=3, attention_module=attention_module)

    x = _depthwise_conv_block(x, 256, alpha, depth_multiplier,
                              strides=(1, 1), block_id=4, attention_module=attention_module)
